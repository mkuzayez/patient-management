                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: const InputDecoration(labelText: 'العمر', prefixIcon: Icon(Icons.calendar_today)),
                          ...
                          //   decoration: const InputDecoration(labelText: 'أمراض سابقة (اختياري)', prefixIcon: Icon(Icons.medical_services)),
                          //   maxLines: 3,
                          // ),
                          const SizedBox(height: 16),
                          DropdownButtonFormField<String>(
                          ...
                          ElevatedButton(
                            ...
                            child: Text(isEditing ? 'تحديث بيانات المريض' : 'إضافة مريض', style: const TextStyle(fontSize: 16)),
                          ),
                        ],
                      ),
                    ),
